  ...
  computed: {
    rules () {
      return {
        ...
        custo_unitario: [(v: number) => v > 0 || 'Custo unitário deve ser maior que 0'],
        preco_venda: [(v: number) => v > 0 || 'Preço de venda deve ser maior que 0'],
        quantidade: [(v: number) => v > 0 || 'Quantidade deve ser maior que 0'],
